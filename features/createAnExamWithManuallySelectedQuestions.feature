Feature: Create new Exam with manually selected questions
In order to create a new exam with manually selected questions
As a lecturer
...
And The lecturer adds questions manually
